...
- **knowledge/** — biblioteca completă de cunoștințe client-facing: un ghid pentru FIECARE modul Symbai (POS & sală, meniu & rețete, stocuri & furnizori, producție & trasabilitate, rezervări & evenimente, personal, rapoarte & P&L, finanțe & e-Factura, livrări & magazin online, marketing & website, echipamente & KDS, setări, AI în aplicație), fiecare cu concepte, pagini, fluxuri pas-cu-pas, întrebări frecvente și capcane. Plus referințele transversale de navigare — **navigare-rapida.md** (cheat-sheet compact intenție→URL pentru cele mai cerute pagini, recall instant), **navigare.md** (cum DUCI userul pe pagină prin extensia Chrome + schimbarea unității active locație/brand), **harta-aplicatiei.md** (indexul exhaustiv al tuturor paginilor și tab-urilor) și **tools-mcp.md** (catalogul complet al tool-urilor conexiunii MCP, cu modelul de permisiuni) — și folderul **knowledge/onboarding/** (planul general + 12 faze pentru configurarea de la zero a unui client nou, folosit de skill-ul `onboarding-symbai`).
