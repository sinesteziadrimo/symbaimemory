...
- **Ciornă întâi, publici la confirmare.** Publicarea cere `metaDescription`≥70 + `coverImageUrl` — dacă lipsesc, lasă pe draft și spune-i userului ce mai trebuie. Nu publica fără să-i arăți textul.
