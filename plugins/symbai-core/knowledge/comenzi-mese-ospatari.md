...
2. Se pot folosi grupurile de clienți per scaun pentru selecție rapidă; produsele fără client sunt grupate la **Comune masă**. Dacă apar cantități fracționare (ex. jumătate de porție, gramaj, kg), POS-ul le afișează la fel în coș, split și preview nota.
