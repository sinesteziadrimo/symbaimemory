...
- **skills/** — workflow-uri pas-cu-pas (găsește o pagină, investighează o masă, adaugă un produs/rețetă, programează o postare, rapoarte & prețuri, trimite ticket de suport/sugestie către echipa Symbai).
- **knowledge/** — biblioteca completă de cunoștințe client-facing: un ghid pentru FIECARE modul Symbai (POS & sală, meniu & rețete, stocuri & furnizori, producție & trasabilitate, rezervări & evenimente, personal, rapoarte & P&L, finanțe & e-Factura, livrări & magazin online, marketing & website, echipamente & KDS, setări, AI în aplicație), fiecare cu concepte, pagini, fluxuri pas-cu-pas, întrebări frecvente și capcane. Plus două referințe transversale: **harta-aplicatiei.md** (indexul tuturor paginilor aplicației) și **tools-mcp.md** (catalogul celor 229 de tool-uri ale conexiunii MCP, cu modelul de permisiuni).
