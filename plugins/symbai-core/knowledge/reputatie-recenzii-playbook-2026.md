...
- **NU configura/seda întrebări-răspuns (Q&A) pe Google Business.** Funcția Q&A din GBP a fost oprită (3 noiembrie 2025) — API-ul nu mai există și funcția se retrage. Google generează acum răspunsuri AI din recenzii, postări și site. Deci: nu mai seda Q&A; în schimb ține recenziile și postările Google bogate (de acolo se hrănește AI-ul) și pune informația reală ca FAQ pe site. ChatGPT, în plus, ia date locale din Bing Places — nu doar din Google.
