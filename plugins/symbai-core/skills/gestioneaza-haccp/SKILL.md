...
## Înainte de orice
1. Citește (la nevoie) **`knowledge/haccp.md`** (ce înseamnă fiecare jurnal, pragurile uzuale, ce e răcirea rapidă/recall, cum se leagă de producție/loturi) și **`knowledge/condu-chrome.md`** (doctrina generală: MCP întâi, deep-link, screenshot = livrabil, click pe element doar când chiar nu există API).
