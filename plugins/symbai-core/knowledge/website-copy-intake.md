...
- **Ticker/marquee:** pentru benzi derulante cu slogane repetate foloseste componenta `marquee` (`items[]`, `speed`, `separator`, `direction`, culori), nu GIF/video/custom HTML.
