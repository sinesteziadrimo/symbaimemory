...
- **Explorează Fabrica** `/factory-explorer` — Vizualizator live read-only al halei: hartă, căutare, Gantt pe utilaje și panouri pentru zonă, magazie/raft, utilaj, operator și produs. Folosește-l pentru screenshot/dovadă vizuală, nu pentru mutări sau scrieri.
