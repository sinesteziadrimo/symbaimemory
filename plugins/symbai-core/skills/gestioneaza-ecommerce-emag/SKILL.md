...
## Înainte de orice
1. Citește **`knowledge/ecommerce-magazin-online.md`** (concepte: variantă, colecție, feed, cod de reducere, RMA, marketplace; paginile; fluxurile pas-cu-pas; capcanele) și **`knowledge/condu-chrome.md`** (cum conduci Chrome: MCP întâi, deep-link, screenshot = livrabil, click doar la nevoie). Pentru partea de **livrare propriu-zisă** (AWB, curieri, dispecerat) leagă și `knowledge/livrari-comenzi-online.md`.
