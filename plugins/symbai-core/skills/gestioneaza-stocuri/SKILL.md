...
3. Daca lucreaza pe zone, verific ca zonele apartin gestiunilor sesiunii. Zonele noi create dupa pornirea inventarului pot fi trimise catre numarator; pentru refacerea asteptatului in sesiunea principala foloseste "Actualizeaza Stocuri" (pastreaza aceeasi data/ora a inventarului).
