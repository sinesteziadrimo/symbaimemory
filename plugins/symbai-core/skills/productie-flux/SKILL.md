...
| „Desenează/aranjează hala fabricii / plan 2D" | Fabrică: creezi/verifici întâi entitățile reale (zone, echipamente, magazii, zone depozitare) prin MCP, apoi folosești browserul pe `/factory-floor-plan` pentru desen/drag pe canvas și îi arăți screenshot. Mutarea pe plan schimbă doar geometria vizuală, nu entitatea reală. |
